    ...
    try {
      ...
      for (const installment of installments) {
        ...
        const result = await insertRequest
          ...
          .input('paidAt', sql.DateTime2, installment.paidAt ?? null)
          .query<InsertedInstallmentRow>(`
      ...
      logDatabaseOperationFailure({
        repository: 'SqlServerInstallmentPersistenceRepository',
        operation: 'replaceByTransactionId',
        entity: 'installments',
        error,
        context: {
          transactionId,
