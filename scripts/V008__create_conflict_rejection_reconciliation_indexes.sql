...
IF NOT EXISTS (
    ...
    WHERE name = 'IX_validation_failures_sync_item_id'
      AND object_id = OBJECT_ID('dbo.validation_failures')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_validation_failures_transaction_id'
      AND object_id = OBJECT_ID('dbo.validation_failures')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_validation_failures_psp_failure_type_created_at'
      AND object_id = OBJECT_ID('dbo.validation_failures')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_rejected_records_sync_item_id'
      AND object_id = OBJECT_ID('dbo.rejected_records')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_rejected_records_validation_failure_id'
      AND object_id = OBJECT_ID('dbo.rejected_records')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_rejected_records_sync_run_id'
      AND object_id = OBJECT_ID('dbo.rejected_records')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_rejected_records_psp_rejection_type_created_at'
      AND object_id = OBJECT_ID('dbo.rejected_records')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_data_conflicts_sync_item_id'
      AND object_id = OBJECT_ID('dbo.data_conflicts')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_data_conflicts_psp_raw_payload_id'
      AND object_id = OBJECT_ID('dbo.data_conflicts')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_data_conflicts_transaction_id'
      AND object_id = OBJECT_ID('dbo.data_conflicts')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_data_conflicts_conflict_type_status_detected_at'
      AND object_id = OBJECT_ID('dbo.data_conflicts')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_data_conflicts_severity_status_detected_at'
      AND object_id = OBJECT_ID('dbo.data_conflicts')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_cases_data_conflict_id'
      AND object_id = OBJECT_ID('dbo.reconciliation_cases')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_cases_sync_item_id'
      AND object_id = OBJECT_ID('dbo.reconciliation_cases')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_cases_transaction_id'
      AND object_id = OBJECT_ID('dbo.reconciliation_cases')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_cases_case_status_severity_opened_at'
      AND object_id = OBJECT_ID('dbo.reconciliation_cases')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_cases_case_type_case_status_opened_at'
      AND object_id = OBJECT_ID('dbo.reconciliation_cases')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_actions_reconciliation_case_id'
      AND object_id = OBJECT_ID('dbo.reconciliation_actions')
)
BEGIN
...
IF NOT EXISTS (
    SELECT 1 FROM sys.indexes
    WHERE name = 'IX_reconciliation_actions_action_type_action_status_acted_at'
      AND object_id = OBJECT_ID('dbo.reconciliation_actions')
)
BEGIN
